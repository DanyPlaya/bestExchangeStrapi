...
export interface ApiBlogDetailBlogDetail extends Schema.CollectionType {
  ...
  attributes: {
    BlogDetailHeader: Attribute.Component<'blog.blog-header'>;
    BlogDetailSeo: Attribute.Component<'page.seo'>;
    BlogDetailMainContent: Attribute.Blocks;
    UIComponents: Attribute.DynamicZone<
      ['ui.button', 'ui.carousel', 'ui.accordion', 'ui.tags']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
